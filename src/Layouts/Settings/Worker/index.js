...
import { SAMPLE_CLIENT_DATA, SAMPLE_DELIVERY_RECORDS, SAMPLE_INVOICE_STATEMENT, SAMPLE_LOCATION_DATA, SAMPLE_VENDOR_DATA } from "../../../utils/constants";
...
const Vendor = (props) => {
  ...
  useEffect(() => {
    ...
    const source = SAMPLE_CLIENT_DATA;
      ...
      <React.Fragment>
        <Grid container spacing={24} justify="space-between" style={{ paddingLeft: 10, paddingRight: 10, paddingTop: 10, paddingBottom: 10 }}>
          <Grid item xs={12}>
            ...
            <Typography variant="h3">Worker/Employee</Typography>
            <br />
          </Grid>
          <Grid item xs={12}>
            <FilterTable />
