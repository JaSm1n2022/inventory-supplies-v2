 ...
 * 
*/
export default function RegularDatePicker({disabled,value,name,onChange,readOnly,label,noDefault,isError,errorMsg,source,	background}) {
  ...
  return (
    ...
    <MuiPickersUtilsProvider utils={DateFnsUtils}>
       <KeyboardDatePicker
          ...
          format="MM/dd/yyyy"
          label={label ?<label hmtlFor="" style={{ fontSize: '10pt' }}>{label}</label> : ''}
