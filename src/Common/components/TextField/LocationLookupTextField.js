...
const ImportIcon = lazy(() => import(/* webpackChunkName: 'listAltIcon' */ "@material-ui/icons/ListAltOutlined"));
...
export default function LocationLookupTextField(
  { id, source, onImport,onChange, variant, label, isError, type, value, errorMsg, readonly, name, placeholder, border, background, disabled, size, height }) {
      ...
      <TextField
        ...
        variant={variant || 'outlined'} InputProps={{
          ...
          endAdornment: (
            ...
            <Tooltip title={<h6 style={{ color: "lightblue" }}>Open contacts</h6>}><Suspense fallback="Loading..."><ImportIcon style={{fontSize: 30}} onClick={() => onImport(source)}/></Suspense></Tooltip>
            </InputAdornment>
          ),
