...
export default function DeleteTextField(
  { id, source, onDelete,onChange, variant, label, isError, type, value, errorMsg, readonly, name, placeholder, border, background, disabled, size, height }) {
      ...
      <TextField
        ...
        variant={variant || 'outlined'} InputProps={{
          ...
          endAdornment: (
            ...
            <Tooltip title={<h6 style={{ color: "lightblue" }}>Delete Reference</h6>}><Suspense fallback="Loading..."><CancelOutlined style={{fontSize: 30,fill:'red'}} onClick={() => onDelete(source)}/></Suspense></Tooltip>
            </InputAdornment>
          ),
