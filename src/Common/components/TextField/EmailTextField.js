...
const EmailIcon = lazy(() => import(/* webpackChunkName: 'iconContactMail' */ "@material-ui/icons/ContactMail"));
        ...
        variant={variant || 'outlined'} InputProps={{
          ...
          endAdornment: (
            <InputAdornment position="end">
              <Suspense fallback="Loading..."><EmailIcon style={{fontSize: 30}}/></Suspense>
            </InputAdornment>
          ),
