...
const ImportIcon = lazy(() => import(/* webpackChunkName: 'iconImportContacts' */ "@material-ui/icons/ImportContacts"));
...
export default function BusinessTextField(
      ...
      <TextField
        ...
        variant={variant || 'outlined'} InputProps={{
          ...
          endAdornment: (
            ...
            <Tooltip title={<h6 style={{ color: "lightblue" }}>Open contacts</h6>}>
              <Suspense fallback="Loading..."><ImportIcon style={{fontSize: 30}}/></Suspense></Tooltip>
            </InputAdornment>
          ),
